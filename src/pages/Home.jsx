      ...
      {showAndroidBanner && (
        <div style={{
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button
              onClick={installApp}
              style={{ padding: "8px 16px", background: "white", color: "#1e3a5f", border: "none", borderRadius: 8, fontWeight: 600, cursor: "pointer", fontSize: 13 }}
            >
              Install
            </button>
            <button
              onClick={() => setShowAndroidBanner(false)}
              style={{ padding: "8px 12px", background: "transparent", color: "white", border: "1px solid rgba(255,255,255,0.4)", borderRadius: 8, cursor: "pointer", fontSize: 13 }}
            >
              ✕
            </button>
          </div>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
            ...
            <button
              ...
              style={{ background: "transparent", border: "none", color: "white", fontSize: 18, cursor: "pointer", padding: 0 }}
            >
              ✕
            </button>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, background: "rgba(255,255,255,0.1)", padding: "10px 14px", borderRadius: 10 }}>
              ...
              <p style={{ margin: 0, fontSize: 14 }}>Tap the <strong>Share</strong> button <span style={{ fontSize: 18 }}>⬆️</span> at the bottom of Safari</p>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 12, background: "rgba(255,255,255,0.1)", padding: "10px 14px", borderRadius: 10 }}>
