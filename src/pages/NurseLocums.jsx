    ...
    <div className="locums-container">
      <div className="locums-header">
        ...
        <div className="header-buttons">
          <button onClick={() => navigate("/nurse/dashboard")}>Dashboard</button>
      ...
      {loading ? (
        ...
        <div className="empty-state">
          ...
          <button onClick={() => navigate("/nurse/dashboard")}>Browse Available Duties</button>
        </div>
      ) : (
              ...
              <div key={duty.id} className={`duty-card ${duty.booking_status === "confirmed" ? "confirmed" : acceptedCoverRequest ? "cover-found" : "pending-card"}`}>
                ...
                {acceptedCoverRequest && (
                  <div className="cover-accepted-info">
                    <p>✅ A nurse has agreed to cover your duty.</p>
                  </div>
                )}
      ...
      {requestingCover && (
        <div className="modal-overlay" onClick={() => setRequestingCover(null)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <p style={{ color: "#e65100", fontSize: 14, marginBottom: 20 }}>⚠️ You remain responsible until another nurse accepts.</p>
